...
<div class="header_top">
  <div class="w960">
    <span class="time">Java1111 - 技术改变人生</span>
      <div class="toplinks">
      <!-- 
        <form target="_blank">
...
<div class="header">
	<div class="w960">
		<div class="title">
			<a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/static/images/logo1.png"></a>
		</div>
