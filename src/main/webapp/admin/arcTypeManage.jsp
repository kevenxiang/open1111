...
<table id="dg" title="帖子类别管理" class="easyui-datagrid"
...
url="${pageContext.request.contextPath}/admin/arcType/list.do" fit="true" toolbar="#tb">
	<thead>
		<tr>
			...
			<th field="typeName" width="80" align="center">帖子类型名称</th>
			<th field="sortNo" width="30" align="center">排列序号</th>
			<th field="keywords" width="100" align="center">SEO关键字 </th>
			<th field="description" width="200" align="center">SEO描述 </th>
		</tr>
	</thead>
</table>
<div id="tb">
