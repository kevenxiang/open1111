...
<title>${arcType.typeName }_Open1111官方网站 -南通小锋网络科技有限公司</title>
<meta name="Author" content="Java1234_小锋老师">
<meta name="keywords"
	content="${arcType.keywords }" />
        ...
        <div class="datas article_type_list">
           <ul>
             <c:forEach var="article" items="${articleList }">
							<li><a target="_blank" href="${pageContext.request.contextPath}/article/${article.id }.html" title="${article.title }">[<fmt:formatDate	value="${article.publishDate }" pattern="MM-dd" />]&nbsp;&nbsp;<font color="${article.titleColor }">${fn:substring(article.title,0,20) }</font></a></li>		
			 </c:forEach>
           </ul>
        </div>
